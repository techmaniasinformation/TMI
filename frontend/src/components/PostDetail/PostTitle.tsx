...
export const PostTitle: React.FC<PostTitleProps> = ({ post, onStarClick }) => {
  return (
    <div className="bg-white rounded-lg shadow-md p-6 mb-6">
      <div className="flex items-start justify-between mb-6">
        ...
        <button 
          onClick={onStarClick}
          className="flex items-center justify-center w-10 h-10 text-yellow-500 hover:text-yellow-600 transition-colors ml-4"
        >
