...
const CustomAlert: React.FC<CustomAlertProps> = ({
  ...
  const getAlertStyles = () => {
    const baseStyles = "fixed top-4 left-1/2 transform -translate-x-1/2 z-50 max-w-sm w-full p-4 rounded-lg shadow-lg transition-all duration-300 ease-in-out";
  ...
  return (
    <div className={`${getAlertStyles()} ${isShowing ? 'translate-y-0 opacity-100' : '-translate-y-full opacity-0'}`}>
