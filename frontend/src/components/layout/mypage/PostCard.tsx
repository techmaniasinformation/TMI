...
const PostCard: React.FC<PostCardProps> = ({ post, onClick }) => {
  ...
  return (
    ...
    >
      {/* 썸네일 영역 */}
      <div className="w-[200px] h-[120px] rounded-xl flex items-center justify-center bg-gray-100 dark:bg-gray-700 overflow-hidden">
        <img
      ...
      <div className="flex-1">
        <h3 className="font-medium text-gray-900 dark:text-white mb-2 break-words break-all">{title}</h3>
