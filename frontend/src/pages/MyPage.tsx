...
import {
  ...
  UserAvatarImage as AvatarImage,
  UserAvatarFallback as AvatarFallback,
  UserBadge as Badge,
  UserInput as Input,
  UserTabs as Tabs,
  UserTabsList as TabsList,
  UserTabsTrigger as TabsTrigger,
  UserTabsContent as TabsContent,
  UserDialog as Dialog,
  UserDialogTrigger as DialogTrigger,
  UserDialogContent as DialogContent,
  UserDialogHeader as DialogHeader,
  UserDialogTitle as DialogTitle,
  UserDialogDescription as DialogDescription,
  UserDialogFooter as DialogFooter,
  UserLabel as Label,
  ComponentManager,
  componentKeys
} from '@/components';
