...
function ServerPagination({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    "aria-label": "\uC774\uC804 \uD398\uC774\uC9C0"
  }, "\uC774\uC804"), pageNumbers.map(page => /*#__PURE__*/React.createElement("button", {
    key: page,
    onClick: e => {
      e.preventDefault();
      handlePageChange(page);
    },
    className: `px-3 py-2 text-sm font-medium rounded-md transition-colors ${currentPage === page ? 'bg-blue-600 text-white' : 'text-gray-700 bg-white border border-gray-300 hover:bg-gray-50'}`,
