...
const useMessageHandler = (isHandled, setIsHandled, navigate) => {
  ...
  const handleMessage = (event, popup, isHandledLocal) => {
    ...
    const allowedOrigins = ['https://i13a509.p.ssafy.io', 'http://localhost:8080', 'http://localhost:3000'];
